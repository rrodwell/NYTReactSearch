						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement('input', { type: 'text', className: 'form-control', id: 'search' })
								),
								React.createElement(
									'div',
									{ className: 'form-group' },
									...
									React.createElement(
										'select',
										{ className: 'form-control', id: 'num-records' },
										React.createElement(
											'option',
											{ value: '1' },
											'1'
								...
								React.createElement(
									...
									React.createElement('input', { type: 'text', className: 'form-control start-year' })
								),
								React.createElement(
									'div',
									{ className: 'form-group' },
									...
									React.createElement('input', { type: 'text', className: 'form-control', id: 'end-year' })
								),
								React.createElement(
									'button',
									{ type: 'submit', className: 'btn btn-primary', id: 'search-btn' },
									'Search'
								),
								React.createElement(
									'button',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// New York Times API
	var nytAPI = "b1fe253f41ce4e66819bdb044a84a61e";
